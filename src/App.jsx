...
import { Smartphone, Zap, Heart, MessageCircle, Clock, ConciergeBell } from 'lucide-react';
...
const ScreenshotPlaceholder = ({ label = "App Screenshot" }) => (
  <div className="w-full h-full bg-gray-100 flex items-center justify-center p-6">
    <div className="w-full h-full border-2 border-dashed border-gray-300 rounded-2xl flex flex-col items-center justify-center text-gray-400">
        <div className="text-4xl mb-3 opacity-50">📱</div>
        <p className="font-medium text-sm text-center">{label}</p>
        <p className="text-xs text-gray-300 mt-2 text-center">Upload later</p>
    </div>
  </div>
);
